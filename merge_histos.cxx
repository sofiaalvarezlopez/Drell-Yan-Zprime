...
void merge_histos()
{
    ...
    //vector<std::string> names_files {"Documents/Universidad/Noveno Semestre/Proyecto Teórico:Computacional/pyroot/DY+jets.root", "Documents/Universidad/Noveno Semestre/Proyecto Teórico:Computacional/pyroot/ttbar.root", "Documents/Universidad/Noveno Semestre/Proyecto Teórico:Computacional/pyroot/ww.root", "Documents/Universidad/Noveno Semestre/Proyecto Teórico:Computacional/pyroot/wz.root", "Documents/Universidad/Noveno Semestre/Proyecto Teórico:Computacional/pyroot/zz.root"};
    vector<std::string> names_files {"Documents/Universidad/Noveno Semestre/Proyecto Teórico:Computacional/pyroot/Zprime_tata_350.root", "Documents/Universidad/Noveno Semestre/Proyecto Teórico:Computacional/pyroot/Zprime_tata_1000.root", "Documents/Universidad/Noveno Semestre/Proyecto Teórico:Computacional/pyroot/Zprime_tata_3000.root"};
    ...
    vector<std::string> names_files_wo_ext {"$m(Z')=350\\,GeV$", "$m(Z')=1000\\,GeV$", "$m(Z')=3000\\,GeV$"};
    ...
    vector<std::string> names {"m(Z')= 350 GeV", "m(Z')= 1000 GeV", "m(Z')= 3000 GeV"};
    ...
    vector<std::string> plots {"Cos_DELTA_PHI taus", "Cos_DELTA_PHI MET tau1", "Cos_DELTA_PHI MET tau2", "DELTA_Pt taus"};
    ...
    vector<std::string> plots_names {"cos(#Delta #phi (#tau_{1}, #tau_{2}))", "cos(#Delta #phi (MET, #tau_{1}))", "cos(#Delta #phi (MET, #tau_{2}))", "#Delta p_{T} (#tau_{1}, #tau_{2})"};
    ...
    {    
        ...
        {
          if( (names_files[j] == "Documents/Universidad/Noveno Semestre/Proyecto Teórico:Computacional/pyroot/DY+jets.root") || (names_files[j] == "Documents/Universidad/Noveno Semestre/Proyecto Teórico:Computacional/pyroot/ttbar.root") || (names_files[j] == "Documents/Universidad/Noveno Semestre/Proyecto Teórico:Computacional/pyroot/ww.root") || (names_files[j] == "Documents/Universidad/Noveno Semestre/Proyecto Teórico:Computacional/pyroot/wz.root") || (names_files[j] == "Documents/Universidad/Noveno Semestre/Proyecto Teórico:Computacional/pyroot/zz.root") || (names_files[j] == "Documents/Universidad/Noveno Semestre/Proyecto Teórico:Computacional/pyroot/Zprime_tata_350.root") || (names_files[j] == "Documents/Universidad/Noveno Semestre/Proyecto Teórico:Computacional/pyroot/Zprime_tata_1000.root") || (names_files[j] == "Documents/Universidad/Noveno Semestre/Proyecto Teórico:Computacional/pyroot/Zprime_tata_3000.root") )
            {  
              h->SetLineColor(colors[j]);
              h->SetLineStyle(linestyles[j]);
              h->SetLineWidth(2);
        ...
        {
          if( (names_files[j] == "Documents/Universidad/Noveno Semestre/Proyecto Teórico:Computacional/pyroot/Zprime_tata_350.root") || (names_files[j] == "Documents/Universidad/Noveno Semestre/Proyecto Teórico:Computacional/pyroot/Zprime_tata_1000.root") || (names_files[j] == "Documents/Universidad/Noveno Semestre/Proyecto Teórico:Computacional/pyroot/Zprime_tata_3000.root") || (names_files[j] == "Documents/Universidad/Noveno Semestre/Proyecto Teórico:Computacional/pyroot/wz.root") || (names_files[j] == "Documents/Universidad/Noveno Semestre/Proyecto Teórico:Computacional/pyroot/zz.root") || (names_files[j] == "signal6.root") || (names_files[j] == "signal7.root") || (names_files[j] == "signal8.root") )
            {
              legend->AddEntry(h,names[j].c_str(),"l");
            }
    ...
    TFile* Output = new TFile("joined_signals.root", "RECREATE"); 
    l->Write();
    Output->Close();
