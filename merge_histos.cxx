...
void merge_histos()
{
    ...
    vector<std::string> x_labels {"#eta(#mu) [a.u.]", "#phi(#mu) [a.u.]", "p_{T}(#mu_{1}) [GeV]", "p_{T}(#mu_{2}) [GeV]", "#Delta R (#mu_{1}, #mu_{2}) [a.u.]", "M(#mu_{1}, #mu_{2}) [GeV]", "Q(#mu_{1})Q(#mu_{2}) [e]", "#Delta #phi (#mu_{1}, #mu_{2}) [a.u.]", "cos(#Delta #phi (#mu_{1}, #mu_{2})) [a.u.]", "MET [GeV]", "cos(#Delta #phi (MET, #mu_{1})) [a.u.]", "M_{T}(#mu_{1}#mu_{2}) [GeV]"};
